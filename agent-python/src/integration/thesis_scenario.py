...
def _build_correlation_decisions() -> List[Dict[str, Any]]:
    candidates = [
        ...
        build_correlation_candidate(
            source="urlhaus",
            source_identifier="CVE-2026-9016",
            target_identifier="UH-FP-KEYWORD",
            relation_type="cve_ioc",
            lexical=0.10,
            semantic=0.20,
            temporal=0.4,
            ...
            exact_cve=False,
            high_signal_term_hits=2,
            raw_reference="https://noise.example/exploit-rce-loader",
        ),
        build_correlation_candidate(
            source="urlhaus",
            source_identifier="CVE-2026-9005",
            target_identifier="UH-FP-STALE",
            relation_type="cve_ioc",
            lexical=0.12,
            semantic=0.22,
            temporal=0.0,
            ...
            exact_cve=False,
            high_signal_term_hits=2,
            raw_reference="https://old-malware.example/vpn-loader-archive",
        ),
        build_correlation_candidate(
            source="urlhaus",
            source_identifier="CVE-2026-9002",
            target_identifier="UH-FP-PRODUCT",
            relation_type="cve_ioc",
            lexical=0.09,
            semantic=0.16,
            temporal=0.3,
            ...
            exact_cve=False,
            high_signal_term_hits=0,
            raw_reference="https://updates.example/example-vpn-admin-theme",
        ),
        build_correlation_candidate(
            source="urlhaus",
            source_identifier="CVE-2026-9016",
            target_identifier="UH-FP-IOC",
            relation_type="cve_ioc",
            lexical=0.03,
            semantic=0.05,
            temporal=0.4,
            ...
            exact_cve=False,
            high_signal_term_hits=0,
            raw_reference="https://ioc.example/payload.bin",
        ),
        build_correlation_candidate(
            source="dread",
            source_identifier="CVE-2026-9001",
...
def _notable_cases(repository: InMemoryScenarioRepository, operational_risk: List[Dict[str, Any]], decisions: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {
            "case": "keyword_only_false_positive_rejected",
            "entity_id": "CVE-2026-9016",
            "description": "Generic exploit/RCE URLhaus wording without exact CVE or entity alignment is rejected.",
            "decision": next((item["status"] for item in decisions if item["target_identifier"] == "UH-FP-KEYWORD"), ""),
            "evidence_gate_passed": next((item["evidence_gate_passed"] for item in decisions if item["target_identifier"] == "UH-FP-KEYWORD"), ""),
            "rejection_reason": next((item.get("rejection_reason", "") for item in decisions if item["target_identifier"] == "UH-FP-KEYWORD"), ""),
        },
        {
            "case": "stale_evidence_rejected_or_capped",
            "entity_id": "CVE-2026-9005",
            "description": "Old external evidence without temporal support is rejected instead of becoming high-confidence support.",
            "decision": next((item["status"] for item in decisions if item["target_identifier"] == "UH-FP-STALE"), ""),
            "final_confidence": next((item["final_confidence"] for item in decisions if item["target_identifier"] == "UH-FP-STALE"), ""),
        },
        {
            "case": "unrelated_product_overlap_rejected",
            "entity_id": "CVE-2026-9002",
            "description": "Shared product/vendor terms without vulnerability context are rejected.",
            "decision": next((item["status"] for item in decisions if item["target_identifier"] == "UH-FP-PRODUCT"), ""),
            "evidence_gate_passed": next((item["evidence_gate_passed"] for item in decisions if item["target_identifier"] == "UH-FP-PRODUCT"), ""),
        },
        {
            "case": "manual_review_not_risk_boost",
            "entity_id": "CVE-2026-9017",
            "description": "Manual-review evidence remains diagnostic and is not counted as accepted external evidence.",
            "manual_review_decisions": sum(1 for item in decisions if item["source_identifier"] == "CVE-2026-9017" and item["status"] == "manual_review"),
            "accepted_evidence_count": sum(item.get("accepted_evidence_count", 0) for item in decisions if item["source_identifier"] == "CVE-2026-9017"),
        },
        {
